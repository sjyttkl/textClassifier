...
==================================================
   ...
   Author :       sjyttkl
   date：          2019/5/26
   Description :  Bi-Lstm train.py 训练数据
==================================================
"""
__author__ = 'sjyttkl'
...
class Train:
    def __init__(self):
        ...
        self.indexFreqs = self._data.indexFreqs  #统计词汇空间中各个词出现在多少个文本中
    ...
    def train(self):
        with tf.Graph().as_default():
            ...
            with sess.as_default():
                adver_lstm = model.AdversarialLSTM(self._config,wordEmbedding=self.wordEmbedding,indexFreqs= self.indexFreqs)
                ...
                #计算梯度，得到梯度和变量
                grads_vars = optimizer.compute_gradients(adver_lstm.loss)
                # 将梯度应用到变量下，生成训练器
