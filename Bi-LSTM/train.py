...
class Train:
    def __init(self):
        ...
        self._data = data_helper.DataSet(self._config).dataGen()
        # 生成训练集和验证集
        ...
        with tf.Graph().as_default():
            ...
            with sess.as_default():
                ...
                def train_step(batchX,batchY):
                    ...
                    acc, auc, precision, recall = self._data.genMetrics(batchY, predictions, binaryPreds)
                    print("train ..{}, step: {}, loss: {},accuracy: {},  acc: {}, auc: {}, precision: {}, recall: {}".format(timeStr, step,
                                                                                                       loss,lstm.accuracy, acc, auc,
                                                                                                       precision,
                                                                                                       recall))
